...
SECRET_KEY = '&x0$nsitv7j@8$nqe=7)j1dn1z0_xyirg(hxeqqrx7sp!qph4y'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,  'templates'), os.path.join(BASE_DIR,'moviesearch', 'templates')],  # Modify this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
